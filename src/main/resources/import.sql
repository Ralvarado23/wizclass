...
insert into noticia (id, titulo, cuerpo, imagen, fecha_publicacion, pagina_id) values (5,'Noticia de ejemplo 5', 'Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo Cuerpo de ejemplo', 'defaultNews.jpg', '7/2/2018', 2);
